...
/**
 * Server Action: marca a integração Tiny da org ativa como desconectada.
 * Mesmo padrão de `disconnectNuvemshop.ts`.
 */
...
export async function disconnectTiny(): Promise<DisconnectResult> {
  ...
  revalidatePath("/app/integrations/tiny");
  return { ok: true };
}
